...
regress_data_harvix2 <- function(Df, outfile) {
  lm1 <- lm(Df$RealizedVariance ~ Df$RealizedVariance %>% lag(1) + Df$RealizedVariance %>% rollapply(5,mean,na.rm = T) %>% lag(1) + Df$RealizedVariance %>% rollapply(20,mean,na.rm = T) %>% lag(1))
  lm2 <- lm(Df$RealizedVariance ~ Df$RealizedVariance %>% lag(1) + Df$RealizedVariance %>% rollapply(5,mean,na.rm = T) %>% lag(1) + Df$RealizedVariance %>% rollapply(20,mean,na.rm = T) %>% lag(1) + Df$VIX.Close)
...
regress_data_harvixln2 <- function(df, outfile) {
  lm3 <- lm(Df$RealizedVariance %>% log() ~ Df$RealizedVariance %>% lag(1) %>% log() + Df$RealizedVariance %>% lag(1) %>% log() %>% rollapply(5,mean,na.rm = T) + Df$RealizedVariance %>% lag(1) %>% log() %>% rollapply(20,mean,na.rm = T))
  lm4 <- lm(Df$RealizedVariance %>% log() ~ Df$RealizedVariance %>% lag(1) %>% log() + Df$RealizedVariance %>% lag(1) %>% log() %>% rollapply(5,mean,na.rm = T) + Df$RealizedVariance %>% lag(1) %>% log() %>% rollapply(20,mean,na.rm = T) + Df$VIX.Close %>% log())
