...
\frametitle{Motivation: Why this project? Why does Volatility matter?}
	\begin{itemize}
	\item Risk measurement for the stability of the financial system
		\begin{itemize}
		\item Volatility is closely related to risk 
		\item Volatility is crucial input to risk measures, such as the Value at Risk
		\end{itemize}
	\item Volatility is used for..
		\begin{itemize}
