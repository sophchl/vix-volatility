...
\section*{Figures}
%
\begin{figure}[!htbp]\label{fig1}\caption{\ac{SPX} and VIX}
\includegraphics[width=16cm, height=8cm]{pictures/SPandViX.png}
\end{figure}
%
\begin{figure}[!htbp]\label{fig2}\caption{\ac{SPX} and RV and VIX}
...
\input{tables/newey1.tex}\label{tab:newey1}
\input{tables/overlap1.tex}\label{tab:overlap1}
\input{tables/overlap2.tex}\label{tab:overlap2}

\section*{F-test Results with Robustness Checks}
\input{tables/ftest1.tex}\label{tab:ftest1}
\input{tables/ftest2.tex}\label{tab:ftest2}
\input{tables/ftestOverlap1.tex}\label{tab:ftestOverlap1}
\input{tables/ftestOverlap2.tex}\label{tab:ftestOverlap2}
%\restoregeometry
%\clearpage
